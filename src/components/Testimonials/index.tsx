...
export const Testimonials = () => {
    return (
        <section className="px-8 pt-64 bg-teal-100">
            <CarouselProvider
                infinite
            ...
            >
                ...
                <DotGroup
                    ...
                    className="max-w-sm mx-auto flex justify-between mt-16"
                ></DotGroup>
                <div className="max-w-sm mx-auto flex justify-between mt-16">
