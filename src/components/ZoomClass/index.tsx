...
export const ZoomClass = () => (
    <Fragment>
        ...
        <section className="zoom-section">
            ...
            <h2>Dance with me!</h2>
            <p>Ms. Liza is private lessons upon request. Support a local independent artist. </p>
            <h3>
                <b>Private Lessons</b>
            </h3>
            <p>
                Email{' '}
                <b>
                    <a href="mailto:liza.kroeschell@gmail.com?subject=Zoom Private Class">liza.kroeschell@gmail.com</a>
                </b>{' '}
